...
class Agent(object):
    ...
    def __init__(self, input_dim, output_dim, hidden_dims=[32, 32]):
        ...
        self.__build_graph(input_dim, output_dim, hidden_dims)

    def __build_graph(self, input_dim, output_dim, hidden_dims=[32, 32]):
        ...
        loss = - log_action_prob * discounted_return_placeholder
        loss = K.mean(loss)
    ...
    def fit(self, S, A, R):
        ...
        self.train_fn([S, action_onehot, discounted_return])
